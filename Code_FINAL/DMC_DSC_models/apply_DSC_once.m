function rent_exponents_logfit = apply_DSC_once(newNetwork, newModules, file_name, Empirical_rent, num_iterations)
...
network_size(:,:,:) = n_s;
numberUniqueNodes(:,:,:) = nUN;
rent_exponents_logfit(:,:,:) = r_e_l;
b2_logfit(:,:,:) = b_l;
mse_logfit(:,:,:) = m_l;
R2_logfit(:,:,:) = R_l;
...
save(['/home/jhow/Documents/OfficialRents/Results_v6/DSC/' file_name '_forwardDSC_singleInstantiation.mat'])
end