function output = main_process_STRING(network_name, module_name, revigo_name, temp_file, revigo_cutoff, species)
poolobj = parpool(30);
%% Import network
...
save(['/home/jhow/Documents/OfficialRents/Results_v6/STRING/' temp_file(1:end-4) '_' revigo_cutoff '.mat'])
clear,clc
output = 0;
end